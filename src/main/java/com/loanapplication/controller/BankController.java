...
public class BankController {
	...
	@GetMapping("/interest-rate-below/{interestRate}")
	public ResponseEntity<List<BankDTO>> getBanksWithInterestRateBelow(@PathVariable double interestRate) {
		List<BankDTO> banks = bankService.getAllBanksWithInterestRateBelow(interestRate);
		return new ResponseEntity<>(banks, HttpStatus.OK);
	}
}
